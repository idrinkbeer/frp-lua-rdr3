...
local blips = {
	...
	{name = "Sheriff (PD)", sprite = 1047294027, x = 1359.64, y = -1304.43, z = 77.77, color = BLIP_COLORS.BLUE2}, --RHODES
	{name = "Sheriff (PD)", sprite = 1047294027, x = 2908.20, y = 1311.53, z = 44.94, color = BLIP_COLORS.BLUE2}, -- ANNESBURGS
	{name = "Police Department", sprite = 1047294027, x = 2512.04, y = -1308.5, z = 48.95, color = BLIP_COLORS.BLUE2}, --SAINT DENIS
...
--	{name = "Loja de Armas", sprite = -145868367, x = -5508.14, y = -2964.33, z = -0.628},  -- tumbleweed
	{name = "Gun Store", sprite = -145868367, x = 2716.42, y = -1285.42, z = 49.63, color = BLIP_COLORS.YELLOW_GREEN}, -- saint dennis
	{name = "Gun Store", sprite = -145868367, x = 1322.67, y = -1323.16, z = 77.88, color = BLIP_COLORS.YELLOW_GREEN}, -- rhodes
...
--	{name = "Estábulo", sprite = 1938782895, x = -1777.02, y = -440.15, z = 154.96}, -- strawberry
	{name = "Stable", sprite = 1938782895, x = 2502.5, y = -1455.33, z = 46.31, color = BLIP_COLORS.TAN}, -- saint dennis
...
--	{name = "Açougue", sprite = -1665418949, x = -341.08, y = 767.16, z = 116.71}, --Cabana de Açougue de Valentine
	{name = "Butcher's", sprite = -1665418949, x = 1296.28, y = -1279.22, z = 75.84, color = BLIP_COLORS.RED}, --Cabana de Açougue de Rhodes
...
--	{name = "Aluguel de Barcos", sprite = 2033397166, x = -686.16, y = -1243.67, z = 43.1},
	{name = "Boat Rental", sprite = 2033397166, x = 2883.17, y = -1354.51, z = 42.61, color = BLIP_COLORS.LIGHT_BLUE}, -- saint dennis
	{name = "Boat Rental", sprite = 2033397166, x = 3030.43, y = 553.86, z = 44.71, color = BLIP_COLORS.LIGHT_BLUE}, -- van horn	

	-- PRISÃO FEDERAL	
	{name = "Federal Prison", sprite = 1047294027, x = 3372.48, y = -667.09, z = 46.41, color = BLIP_COLORS.LIGHT_BLUE},

	-- LOJA DE ROUPAS
	{name = "Tailor", sprite = 1195729388, x = 2549.83, y = -1160.05, z = 53.73, color = BLIP_COLORS.ORANGE}, -- saint dennis
...
--	{name = "Saloon", sprite = 1879260108, x = -311.67, y = 806.43, z = 118.98}, -- valentine
	...
	{name = "Bank", sprite = -2128054417, x = 2642.879, y = -1296.995, z = 52.252, color = BLIP_COLORS.LIGHT_YELLOW2}, -- saint DENIS
	{name = "Bank", sprite = -2128054417, x = 1299.520, y = -1300.899, z = 77.625, color = BLIP_COLORS.LIGHT_YELLOW2}, -- rhodes

	{name = "Theater", sprite = -417940443, x = 2547.876, y = -1308.547, z = 49.287}, -- Saint Dennis
...
--	{name = "Correio", sprite = 1861010125, x = -872.21, y = -1334.13, z = 43.97},
	...
	{name = "Post Office", sprite = 1861010125, x = 1233.23, y = -1294.56, z = 76.65}, -- rhodes

	--FORTES
	{name = "Fort", sprite = 1322310532, x = 348.66, y = 1485.12, z = 181.17},
	{name = "Fort2", sprite = 1322310532, x = -1403.27, y = -2317.49, z = 43.62},

	--HOTELES
--	{name = "Motel", sprite = -211556852, x = -325.74, y = 772.92, z = 117.44},

	--Loja de itens
	{name = "General Store", sprite = 249721687, x = 1327.907, y = -1292.865, z = 77.023}, -- rhodes
	--{name = "Loja de itens", sprite = 249721687, x = -785.338, y = -1323.850, z = 43.884}, -- blackwater

	{name = "Trading Post", sprite = -242384756, x = 3027.058, y = 561.334, z = 44.794}, -- van horn
...
--	{name = "Loja de aluguel de Carroça", sprite = 1012165077, x = -396.48, y = 654.25, z = 114.66}, -- valentine
	{name = "Cart Rental", sprite = 1012165077, x = 1889.65, y = -1343.7, z = 42.51}, -- saint dennis
	--{name = "Loja de aluguel de Carroça", sprite = 1012165077, x = -5514.86, y = -3044.4, z = -2.39},

	--CRIAÇAO DE BANDO
	{name = "Create Posse", sprite = -428972082, x = -374.009, y = 724.092, z = 116.359},
	{name = "Mine", sprite = 2107754879, x = 2752.87, y = 1364.09, z = 67.91},

	{name = "Mine", sprite = 2107754879, x = 2293.26, y = 1070.23, z = 81.43},	

	{name = "Native Village", sprite = -1944395098, x = 449.36, y = 2234.05, z = 247.65},  
